...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _gsap_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gsap.min.js */ "./src/scripts/gsap.min.js");
...
/* harmony import */ var _ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ScrollTrigger.min.js */ "./src/scripts/ScrollTrigger.min.js");
/* harmony import */ var _ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1__);


const scrollSections = _gsap_min_js__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray('.scroll-target');
const links = _gsap_min_js__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray('.inpage-links a');
const activeClass = 'is-active';
scrollSections.forEach((section, i) => {
  const link = links[i];
  _ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.create({
    trigger: section,
